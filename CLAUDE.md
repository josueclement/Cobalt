...
- `Controls/` — TemplatedControls: `NavigationControl`, `NavigationItemControl`, `ContentDialog`, `OverlayControl`, `InfoBarControl`
- `Services/` — Each control has a matching service + interface: `NavigationService`, `ContentDialogService`, `OverlayService`, `InfoBarService`
