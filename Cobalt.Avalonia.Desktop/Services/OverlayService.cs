...
/// Manages a single OverlayPresenter host and controls its visibility and content.
/// </summary>
public class OverlayService : IOverlayService
{
    /// <summary>
    /// The registered OverlayPresenter control used to display overlay content.
    /// </summary>
    private OverlayPresenter? _host;

    /// <summary>
    /// Registers the host OverlayPresenter control that will be used to display all overlay content.
    /// This must be called once during application initialization before showing any overlays.
    /// </summary>
    /// <param name="presenter">The OverlayPresenter to register as the host.</param>
    ...
    /// <exception cref="InvalidOperationException">Thrown if no OverlayPresenter host has been registered.</exception>
